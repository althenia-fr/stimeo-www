        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-0 items-stretch relative">
           ...
           <div class="lg:col-span-7 relative z-20 pr-0 lg:pr-8 py-8">
              <h1 class="font-extrabold mb-4 text-5xl lg:text-6xl">
                <span class="liquid-highlight">Urologie</span>
              </h1>
              <p class="text-lg font-normal leading-relaxed" style="color: #4A4A4A">
                L'urologie est un domaine de santé qui demande expertise, discrétion et confiance. STIMÉO met à votre service une gamme complète de solutions adaptées, soutenues par des infirmiers spécialisés et un suivi coordonné. Notre objectif : vous offrir autonomie et dignité, chaque jour.
              </p>
           </div>

           <div class="lg:col-span-5 relative z-10">
              <div class="expertise-photo-vignette rounded-4xl h-[380px] shadow-xl overflow-hidden">
                 <img src="https://cdn.builder.io/api/v1/image/assets%2Ff2976922c6674ae58e827df6ab219826%2Fdf233b0d8aa6493ab5c58b35f23f9633?format=webp&width=800" alt="Matériel d'urologie discret" class="w-full h-full object-cover" />
              </div>
           </div>
        </div>
      </div>
      ...
      <div class="container-width">
        <div class="bg-white rounded-3xl p-8 lg:p-12 relative overflow-hidden shadow-lg border border-gray-100">
           ...
           <div class="relative z-10">
              <div class="max-w-2xl">
                 <h2 class="font-extrabold text-3xl lg:text-4xl mb-4 animate-fade-in-up-enhanced" style="color: #2D2D2D">Solutions & <span class="text-brand-gold">Accompagnement</span></h2>
                 <p class="text-base font-medium mb-8 leading-relaxed" style="color: #4A4A4A">
                    L'urologie nécessite une approche délicate et experte. STIMÉO s'engage à vous fournir le matériel le plus adapté et un suivi rigoureux par des infirmiers spécialisés.
                 </p>
                 ...
                 <ul class="grid grid-cols-1 gap-4 mb-8">
                    <li class="flex items-start">
                       ...
                       <div>
                          <h4 class="font-bold text-lg mb-0.5" style="color: #2D2D2D">Sondes Urinaires</h4>
                          <p class="text-sm" style="color: #4A4A4A">Large gamme de sondes hydrophiles et prêtes à l'emploi.</p>
                       </div>
                    </li>
                    <li class="flex items-start">
                       <CheckIcon class="mr-3 mt-1 text-brand-gold flex-shrink-0" />
                       <div>
                          <h4 class="font-bold text-lg mb-0.5" style="color: #2D2D2D">Poches de Recueil</h4>
                          <p class="text-sm" style="color: #4A4A4A">Systèmes discrets, sécurisés et confortables.</p>
                       </div>
                    </li>
                    <li class="flex items-start">
                       <CheckIcon class="mr-3 mt-1 text-brand-gold flex-shrink-0" />
                       <div>
                          <h4 class="font-bold text-lg mb-0.5" style="color: #2D2D2D">Hygiène & Soins</h4>
                          <p class="text-sm" style="color: #4A4A4A">Produits spécifiques pour la prévention des infections.</p>
                       </div>
                    </li>
                 </ul>

                 <h3 class="font-bold text-xl mb-3" style="color: #2D2D2D">L'apport du Digital</h3>
                 <p class="leading-relaxed text-sm pb-32 md:pb-0" style="color: #4A4A4A">
                    Avec Stiméo+, suivez votre consommation, planifiez vos livraisons et accédez à des tutoriels vidéo pour gagner en autonomie.
                 </p>
              </div>
           </div>

           <!-- Advice Block - Absolute on desktop, normal flow on mobile -->
           <div class="advice-block-container mt-8 md:mt-0 animate-fade-in-up-advice">
              <div class="bg-white rounded-4xl p-6 shadow-advice border border-gray-100">
                 <h4 class="font-bold text-lg mb-3" style="color: #2D2D2D">Besoin d'un conseil ?</h4>
                 <p class="text-sm mb-4" style="color: #4A4A4A">Nos infirmiers coordinateurs vous répondent.</p>
