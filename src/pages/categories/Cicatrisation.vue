        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-0 items-stretch relative">
           ...
           <div class="lg:col-span-7 relative z-20 pr-0 lg:pr-8 py-8">
              <h1 class="font-extrabold mb-4 text-5xl lg:text-6xl">
                <span class="liquid-highlight">Cicatrisation</span>
              </h1>
              <p class="text-lg font-normal leading-relaxed" style="color: #4A4A4A">
                Parce que chaque plaie est unique et nécessite une attention particulière, nous mettons à votre service une expertise de pointe dans la gestion des plaies complexes. Grâce à des protocoles de soin avancés et une sélection rigoureuse des dispositifs les plus performants, nous créons les conditions optimales pour une guérison rapide, sécurisée et durable à domicile.
              </p>
           </div>
           
           <div class="lg:col-span-5 relative z-10">
              <div class="expertise-photo-vignette rounded-4xl h-[380px] shadow-xl overflow-hidden">
                 <img src="https://cdn.builder.io/api/v1/image/assets%2Ff2976922c6674ae58e827df6ab219826%2F9b423f639c904833807158b4ba87f6e6?format=webp&width=800" alt="Cicatrisation et soins à domicile" class="w-full h-full object-cover" />
              </div>
           </div>
        </div>
      </div>
      ...
      <div class="container-width">
        <div class="bg-white rounded-3xl p-8 lg:p-12 relative overflow-hidden shadow-lg border border-gray-100">
           ...
           <div class="grid grid-cols-1 lg:grid-cols-1 gap-10 relative z-10">
              <div>
                 <h2 class="font-extrabold text-3xl lg:text-4xl mb-4 animate-fade-in-up-enhanced" style="color: #2D2D2D">Science de la <span class="text-brand-gold">Cicatrisation</span></h2>
                 <p class="text-base font-medium mb-8 leading-relaxed" style="color: #4A4A4A">
                    Chaque plaie est unique et mérite une prise en charge spécialisée. Nous sélectionnons les dispositifs les plus performants pour créer les conditions optimales de guérison, adaptés à votre situation clinique.
                 </p>
                 ...
                 <ul class="grid grid-cols-1 gap-4 mb-8">
                    <li class="flex items-start">
                       ...
                       <div>
                          <h4 class="font-bold text-lg mb-0.5" style="color: #2D2D2D">Hydrocellulaires</h4>
                          <p class="text-sm" style="color: #4A4A4A">Une gestion optimale des exsudats en milieu humide pour favoriser le bourgeonnement.</p>
                       </div>
                    </li>
                    <li class="flex items-start">
                       <CheckIcon class="mr-3 mt-1 text-brand-gold flex-shrink-0" />
                       <div>
                          <h4 class="font-bold text-lg mb-0.5" style="color: #2D2D2D">Alginates & Fibres</h4>
                          <p class="text-sm" style="color: #4A4A4A">Une absorption haute capacité et une détersion efficace pour les plaies cavitaires ou fibrineuses.</p>
                       </div>
                    </li>
                    <li class="flex items-start">
                       <CheckIcon class="mr-3 mt-1 text-brand-gold flex-shrink-0" />
                       <div>
                          <h4 class="font-bold text-lg mb-0.5" style="color: #2D2D2D">Interfaces</h4>
                          <p class="text-sm" style="color: #4A4A4A">Une protection maximale des tissus fragiles et des retraits indolores pour votre confort.</p>
                       </div>
                    </li>
                    <li class="flex items-start">
                       <CheckIcon class="mr-3 mt-1 text-brand-gold flex-shrink-0" />
                       <div>
                          <h4 class="font-bold text-lg mb-0.5" style="color: #2D2D2D">Sets de Soins</h4>
                          <p class="text-sm" style="color: #4A4A4A">Des kits stériles complets et prêts à l'emploi pour garantir une asepsie parfaite.</p>
                       </div>
                    </li>
                 </ul>

                 <h3 class="font-bold text-xl mb-3" style="color: #2D2D2D">Expertise Connectée</h3>
                 <p class="leading-relaxed text-sm pb-32 md:pb-0" style="color: #4A4A4A">
                    La télé-expertise plaies via Stiméo Connect permet d'ajuster le protocole en temps réel sur avis spécialisé, sans déplacement inutile du patient.
                 </p>
              </div>
           </div>
           ...
           <div class="advice-block-container mt-8 md:mt-0 animate-fade-in-up-advice">
              <div class="bg-white rounded-4xl p-6 shadow-advice border border-gray-100">
                 <h4 class="font-bold text-lg mb-3" style="color: #2D2D2D">Une question ?</h4>
                 <p class="text-sm mb-4" style="color: #4A4A4A">Nos experts plaies et cicatrisation vous répondent.</p>
